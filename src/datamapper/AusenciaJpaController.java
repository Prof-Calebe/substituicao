...
public class AusenciaJpaController implements Serializable {
    ...
    /**
     * This Method tryes to override an already existent object Ausencia in the
     * DataBase with the same Id. It's an update.
     *
    ...
    /**
     * This method tryes to remove an existing object from the DataBase based on
     * it's id.
     *
    ...
    /**
     * This method lists some Ausencia Objects on the DataBase utilizing this
