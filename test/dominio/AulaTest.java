...
public class AulaTest {
    ...
    public void testeDeveSerPossivelVerSeDuasAulasBatemNosDiasOuHorarios() {
        ...
        Aula aula2 = new Aula(AULA_NOME, DateTimeConstants.MONDAY, periodo2);
    ...
    public void testeDeveSerAvaliadaIgualÀOutraAulaSomenteSeCasarEmDiaDaSemanaEPeríodo() {
        ...
        objetoEmTeste = new Aula(AULA_NOME, DateTimeConstants.MONDAY, periodo);
        Aula outraAula = new Aula(AULA_NOME, DateTimeConstants.MONDAY, periodo);
        assertTrue(objetoEmTeste.equals(outraAula));

        outraAula = new Aula(AULA_NOME, DateTimeConstants.MONDAY, periodo2);
        assertFalse(objetoEmTeste.equals(outraAula));

        outraAula = new Aula(AULA_NOME, DateTimeConstants.TUESDAY, periodo);
        assertFalse(objetoEmTeste.equals(outraAula));
    }
